SINGLE_MODEL_LAGGER_EXPLORER <- function(m=1, nlags=0:2, seed=0, proj_name='ET1_LAGGER1'){
  ...
  params = list(booster='gbtree', objective='reg:logistic', eta=runif(1, 0.05, 0.1),
                subsample=runif(1, 0.7, 0.99), colsample_bytree=runif(1, 0.5, 0.99),
...
SINGLE_MODEL_LAGGER_EXPLORER(m = 1, nlags = 0:2, seed = 1, proj_name = 'ET1_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 2, nlags = 0:2, seed = 1, proj_name = 'ET2_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 3, nlags = 0:2, seed = 2, proj_name = 'GBLINEAR1_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 5, nlags = 0:2, seed = 3, proj_name = 'GBTREE1_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 7, nlags = 0:2, seed = 4, proj_name = 'GBTREE3_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 9, nlags = 0:2, seed = 5, proj_name = 'RF1_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 10, nlags = 0:2, seed = 6, proj_name = 'RF2_LAGGER1_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 3, nlags = c(0,2,4), seed = 7, proj_name = 'GBLINEAR1_LAGGER2_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 7, nlags = c(0,2,4), seed = 8, proj_name = 'GBTREE3_LAGGER2_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 9, nlags = c(0,2,4), seed = 9, proj_name = 'RF1_LAGGER2_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 1, nlags = c(0,2,4), seed = 10, proj_name = 'ET1_LAGGER2_XGBTREE')
gc()
SINGLE_MODEL_LAGGER_EXPLORER(m = 7, nlags = 0:4, seed = 11, proj_name = 'GBTREE3_LAGGER3_XGBTREE')
gc()
