...
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(9,10), nlags = 0:2, seed = 1, proj_name = 'RF1_RF2_LAGGER1_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(1,9), nlags = 0:2, seed = 2, proj_name = 'ET1_RF1_LAGGER1_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(3,7), nlags = 0:2, seed = 3, proj_name = 'GBLINEAR1_GBTREE3_LAGGER1_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(3,7), nlags = 0:4, seed = 4, proj_name = 'GBLINEAR1_GBTREE3_LAGGER2_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(9,7), nlags = 0:2, seed = 5, proj_name = 'RF1_GBTREE3_LAGGER1_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(1,7), nlags = 0:2, seed = 6, proj_name = 'ET1_GBTREE3_LAGGER1_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(3,7,9), nlags = 0:2, seed = 7, proj_name = 'GBLINEAR1_GBTREE3_RF1_LAGGER1_XGBTREE')
gc()
MULTIPLE_MODEL_LAGGER_EXPLORER(m = c(3,7,9), nlags = 0:3, seed = 8, proj_name = 'GBLINEAR1_GBTREE3_RF1_LAGGER2_XGBTREE')
gc()
